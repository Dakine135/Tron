function Board(){
	//canvas stuff
    this.canvasWidth = Math.round((window.innerWidth - 50)/GAMEGRIDSCALE)*GAMEGRIDSCALE;
    this.canvasHeight = Math.round((window.innerHeight - 100)/GAMEGRIDSCALE)*GAMEGRIDSCALE;
	this.canvas = null;
